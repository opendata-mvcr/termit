...
public class Configuration {
    ...
    public static class Repository {
        ...
        /**
         * Container for vocabulary cache.
         */
        ...
        public String getCanonicalContainer() {
            return canonicalContainer;
        }

        public void setCanonicalContainer(String canonicalContainer) {
            this.canonicalContainer = canonicalContainer;
        }
    }
